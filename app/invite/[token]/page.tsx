...
export default function InvitePage() {
  ...
  const connected = viewer.status === "joined" && viewer.connection?.status === "connected";
  ...
  if (connected) {
    return (
      ...
      >
        ...
        <p className="text-sm" style={{ color: "var(--color-muted)" }}>
          Your calendar is connected for <strong>{event.title}</strong>. We&rsquo;ll email{" "}
          <strong>{viewer.email}</strong> as soon as there&rsquo;s a time to confirm.
        </p>
